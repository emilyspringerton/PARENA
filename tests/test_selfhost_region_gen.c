...
Option scope_lookup(Vec * scope __attribute__((unused)), char * name __attribute__((unused)), Arena *dest __attribute__((unused))) {
    Option __loop_result_11 __attribute__((unused));
    int i = (vec_len(scope) - 1);
    while (1) {
        if ((i < 0)) {
        __loop_result_11 = option_none();
        break;
        } else {
        Binding *b __attribute__((unused)) = vec_get(scope, i);
        if (str_eq_(((*((Binding *)(b)))).name, name)) {
        __loop_result_11 = option_some(Binding_box(dest, (*((Binding *)(b)))));
        break;
        } else {
...
Option handle_symbol_headed_call(Node * node __attribute__((unused)), Vec * scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    ...
    Option __match_tmp_13 = check_call_escape(node, scope, dest_arena);
    if (__match_tmp_13.tag == 1) {
        void *e __attribute__((unused)) = __match_tmp_13.value;
        __match_result_8 = option_some(e);
    }
    else if (__match_tmp_13.tag == 0) {
        __match_result_8 = walk_children(node, scope, dest_arena);
    }
...
Option walk_body_from(Node * node __attribute__((unused)), int start __attribute__((unused)), Vec * scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    Option __loop_result_13 __attribute__((unused));
    int i = start;
    while (1) {
        if ((i >= vec_len(&((node)->children)))) {
        __loop_result_13 = option_none();
        break;
        } else {
    Option __match_tmp_14 = walk(vec_get(&((node)->children), i), scope, dest_arena);
    if (__match_tmp_14.tag == 1) {
        void *e __attribute__((unused)) = __match_tmp_14.value;
        __loop_result_13 = option_some(e);
        break;
    }
...
Option check_call_escape(Node * call __attribute__((unused)), Vec * scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    ...
    Option __match_tmp_15 = scope_lookup(scope, (dest_node)->text, dest_arena);
    if (__match_tmp_15.tag == 0) {
        __match_result_9 = option_none();
    }
    else if (__match_tmp_15.tag == 1) {
        void *db __attribute__((unused)) = __match_tmp_15.value;
    ...
    if (__match_tmp_16.tag == 0) {
        ...
        void *sb __attribute__((unused)) = __match_tmp_16.value;
...
char * region_kw_of_expr(Node * expr_node __attribute__((unused)), Vec * scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    char * __match_result_10 __attribute__((unused)) = {0};
    Option __match_tmp_17 = alloc_rank(expr_node, scope, dest_arena);
    if (__match_tmp_17.tag == 1) {
        void *b __attribute__((unused)) = __match_tmp_17.value;
        __match_result_10 = ((*((Binding *)(b)))).region_name;
    }
...
Result walk_let_bindings(Node * bindings __attribute__((unused)), Vec * outer_scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    ...
    while (1) {
        ...
        __loop_result_14 = result_ok(ScopeResult_box(dest_arena, ScopeResult_new(acc_scope)));
        break;
        } else {
    ...
    Option __match_tmp_18 = walk(expr_node, outer_scope, dest_arena);
...
Option walk_let(Node * node __attribute__((unused)), Vec * scope __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    ...
    Result __match_tmp_19 = walk_let_bindings(bindings, scope, dest_arena);
    if (__match_tmp_19.tag == 0) {
        void *e __attribute__((unused)) = __match_tmp_19.value;
        __match_result_11 = option_some(e);
    }
    else if (__match_tmp_19.tag == 1) {
        void *sr __attribute__((unused)) = __match_tmp_19.value;
        __match_result_11 = walk_body_from(node, 2, &(((*((ScopeResult *)(sr)))).scope), dest_arena);
    }
...
Option region_analyze(Node * program __attribute__((unused)), Arena *dest_arena __attribute__((unused))) {
    ...
    Option __match_tmp_20 = analyze_defn(form, dest_arena);
    if (__match_tmp_20.tag == 1) {
        void *e __attribute__((unused)) = __match_tmp_20.value;
        __loop_result_16 = option_some(e);
        break;
    }
